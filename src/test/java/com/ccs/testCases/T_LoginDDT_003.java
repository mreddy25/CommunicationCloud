...
public class T_LoginDDT_003 extends BaseClass
{
	...
	/*
	 * @DataProvider(name="LoginData") public Object[][] testDataExample(){
	 * ReadExcelFile configuration = new ReadExcelFile(
	 * "D:\\Selenium\\MyWorkspace\\CommunicationCloud\\src\\test\\java\\com\\ccs\\testData\\LoginData.xlsx"
	 * ); int rows = configuration.getRowCount(0); Object[][]signin_credentials =
	 * new Object[rows][2];
	 * 
	 * for(int i=0;i<rows;i++) {
	 * 
	 * signin_credentials[i][0] = configuration.getData(0, i, 0);
	 * signin_credentials[i][1] = configuration.getData(0, i, 1); } return
	 * signin_credentials; } }
	 */
	  ...
	  int colcount=XLUtils.getCellCount(path,
	  "Sheet1", 1); //here 1- row number
